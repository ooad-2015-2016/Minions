...
namespace ProjekatAutomaticCarParkingSystem
{
    class Supervizor:Osoba
    {
        ...
        public Supervizor(String _ime, String _prezime, String _brojtelefona, String _adresa, String _brojlicne, DateTime _datumrodjenja, String _username, String _pasword)
        ...
        List<DolazakNaPosao> PregledajDolakse()
        {
            return KontejnerskaKlasa.dolasci;
        }
        void UplatiNovac() { }
    }
}
